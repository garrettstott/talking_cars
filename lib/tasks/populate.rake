...
def set_forums(model)
  [
    ...
    {name: 'Warranty Issues & SOA Problems', description: 'The Warranty Issues & SOA Problems forum on Talking Cars is for discussion about your warranty issues, general problems or questions regarding SOA warranties.', category: 'General', model_id: model.id},
